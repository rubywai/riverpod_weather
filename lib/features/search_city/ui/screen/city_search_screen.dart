          ...
          Padding(
            ...
            child: TextField(
              ...
              decoration:  InputDecoration(
                  border: const OutlineInputBorder(), labelText: 'Search city',
                suffixIcon: IconButton(onPressed: (){
                   String city = _citySearchTextController.text.trim();
                   if(city.isEmpty){
                     ScaffoldMessenger.of(context)
                         .showSnackBar(const SnackBar(content: Text('Please Enter completely')));
                   }
                   else{
    ...
    return Center(
      child: switch (citySearchState) {
        ...
        CitySearchSuccess(
         ...
         CityList(citySearchResult: citySearchResult,),
